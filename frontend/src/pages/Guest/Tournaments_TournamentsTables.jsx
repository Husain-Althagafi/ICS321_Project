...
import "../../stylesheets/Tournaments_TournamentsTables.css";
import GuestSidebar from "../../components/GuestSidebar";

const Tournaments_TournamentsTables = () => {
              ...
              tournaments.map((tournament) => (
                <div key={tournament.tournament_id} className="tournament-card">
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(`/guest/view-tournament-table/${tournament.tournament_id}`)
                    }
                  >
                    View
                  </button>
...
export default Tournaments_TournamentsTables;
